  ...
  <div class="signup">
    ...
    <div class="card-body">
      <form method="POST" action="{{ route('register') }}">
        ...
        <div class="signup-form">
          <label for="account-name" class="col-md-4 col-form-label text-md-right">{{ __('アカウント名') }}</label>

          <div class="col-md-6">
            <input id="account-name" type="text" class="form-control @error('account_name') is-invalid @enderror" name="account_name" value="{{ old('account_name') }}" required autocomplete="account_name" autofocus>
        ...
        <div class="access">
          ...
          <div class="not-signup">登録せずに利用する場合 ：<a href="/">こちら</a></div>
        </div>
